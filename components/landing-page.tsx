                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">8 channels • 2.4M subscribers</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { icon: Laptop, name: "Tech Reviews", count: 12, color: "from-blue-500 to-cyan-500" },
                      { icon: Utensils, name: "Cooking", count: 6, color: "from-green-500 to-emerald-500" },
                      { icon: Dumbbell, name: "Fitness", count: 9, color: "from-purple-500 to-violet-500" },
                      { icon: Plane, name: "Travel", count: 7, color: "from-orange-500 to-red-500" },
                    ].map((group, index) => (
      ...
      <section id="features" className="py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">{t("features.subtitle")}</p>
          </div>
      ...
      <section id="integrations" className="py-20 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold">{t("integrations.title")}</h2>
            <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">{t("integrations.subtitle")}</p>
          </div>
              ...
              >
                ...
                <CardHeader className="pb-4">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <CardTitle className="group-hover:text-primary transition-colors">{integration.name}</CardTitle>
                    <Badge variant={integration.badge === "New" ? "default" : "secondary"} className="shadow-sm">
                      {integration.badge}
                    </Badge>
                  </div>
                </CardHeader>
      ...
      <section id="testimonials" className="py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold">{t("testimonials.title")}</h2>
            <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">{t("testimonials.subtitle")}</p>
          </div>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-red-500 to-pink-500 flex items-center justify-center shadow-lg">
                      <span className="text-lg font-medium text-white">{testimonial.name.charAt(0)}</span>
                    </div>
                    <div>
      ...
      <section id="pricing" className="py-20 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold">{t("pricing.title")}</h2>
            <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">{t("pricing.subtitle")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card
                key={index}
                className={cn("relative group hover:scale-105 transition-all duration-300 border-2", plan.color)}
              >
                {plan.popular && (
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-red-500 via-pink-500 to-orange-500 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <div className="space-y-8 max-w-4xl mx-auto">
            <Badge variant="outline" className="border-white/20 bg-white/10 text-white mb-4">
              <Rocket className="mr-2 h-3 w-3" />
              {t("cta.badge")}
            </Badge>
            <h2 className="text-3xl lg:text-6xl font-bold">{t("cta.title")}</h2>
            <p className="text-xl lg:text-2xl opacity-90 leading-relaxed">{t("cta.subtitle")}</p>
