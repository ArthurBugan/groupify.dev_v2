								...
								{socialConnections.google.connected ? (
									<div className="space-y-1">
										<p className="text-sm text-muted-foreground">
											{socialConnections.google.email}
										</p>
										<p className="text-xs text-muted-foreground">
											Connected on{" "}
											{new Date(
												socialConnections.google.connectedAt!,
											).toLocaleDateString()}
										</p>
									</div>
								) : (
								...
								{socialConnections.apple.connected ? (
									<div className="space-y-1">
										...
										<p className="text-xs text-muted-foreground">
											Connected on{" "}
											{new Date(
												socialConnections.apple.connectedAt!,
											).toLocaleDateString()}
										</p>
									</div>
								) : (
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-blue-700 mt-1">
									Connecting social accounts allows for secure, passwordless
									sign-in and provides backup access to your account.
								</p>
							</div>
						</div>
					</div>
