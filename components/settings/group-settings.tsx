    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure default settings for channel groups</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="max-channels">Maximum Channels per Group</Label>
              <p className="text-sm text-muted-foreground">Limit the number of channels in a single group</p>
            </div>
            <Input
              id="max-channels"
              type="number"
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Allow the same channel in multiple groups</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Automatically sort channels by subscriber count</p>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage available categories for organizing groups</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Settings applied to newly created groups</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
