        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Allow us to track page views and feature usage</p>
            </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex justify-between py-2">
              ...
              <span className="text-sm text-muted-foreground">Until deletion</span>
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      This will permanently delete all your groups, channels, and settings. This action cannot be
                      undone.
                    </DialogDescription>
                  </DialogHeader>
