...
import { useNavigate, createFileRoute, useLocation, useRouter } from "@tanstack/react-router"
...
export const Route = createFileRoute("/_app/dashboard/channels/change-group/[id]/")({
