  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <DashboardHeader title="Create New Group" description="Create a new YouTube channel group" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <IconPicker value="twemoji:file-folder" onChange={(value) => setGroup({ ...group, icon: value })} />
              ...
              <div className="grid gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Creating a subgroup allows you to organize channels hierarchically
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button type="submit" variant="outline" type="button"  disabled={isLoading}>
                {isLoading ? (
                  "Creating..."
                ) : (
                  <>
