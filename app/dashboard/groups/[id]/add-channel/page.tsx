...
import { ArrowLeft, Search, Plus, Youtube } from "lucide-react"
...
export default function AddChannelPage({ params }: AddChannelPageProps) {
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                      ...
                      {searchResults.map((channel) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <Badge variant="outline">{channel.subscribers}</Badge>
                              </div>
                          ...
                          <Button
                            ...
                            disabled={selectedChannels.some((c) => c.id === channel.id)}
                          >
                            {selectedChannels.some((c) => c.id === channel.id) ? "Added" : "Add"}
                          </Button>
                        </div>
                      ))}
                    </div>
            ...
            <TabsContent value="manual" className="space-y-4">
                    ...
                    <div className="grid gap-4">
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setManualChannel({ ...manualChannel, name: e.target.value })}
                          required
                        />
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setManualChannel({ ...manualChannel, url: e.target.value })}
                          required
                        />
                      </div>
                    </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  For manually added channels, subscriber counts and video statistics will be fetched when you save.
                </AlertDescription>
              </Alert>
            </TabsContent>
          </Tabs>
        ...
        <div>
          <Card className="sticky top-6">
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium mb-2">Selected Channels ({selectedChannels.length})</h3>
                  <Separator />
                </div>
                ...
                {selectedChannels.length === 0 ? (
                  <div className="text-center py-6 text-muted-foreground">
                    ...
                    <p className="text-xs mt-1">Search or add channels manually</p>
                  </div>
                ) : (
                ...
                <div className="pt-2">
                  ...
                  >
                    {isAdding ? (
                      ...
                      <>
                        Add {selectedChannels.length} Channel{selectedChannels.length !== 1 && "s"} to Group
                      </>
                    )}
                  </Button>
                </div>
